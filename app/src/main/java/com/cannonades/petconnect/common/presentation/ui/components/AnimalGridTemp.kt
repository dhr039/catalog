...
@Composable
fun AnimalGridTemp(modifier: Modifier, viewState: AnimalsListViewState, categId: Int, onEvent: (Int) -> Unit) {
    Box(
        ...
        LazyVerticalGrid(
            ...
            content = {
                itemsIndexed(viewState.animals) { index, animal ->
                    UIAnimalComposableTemp(modifier = modifier, animal = animal)
...
@Composable
fun UIAnimalComposableTemp(modifier: Modifier, animal: UIAnimal) {
